...
- **Tenancy & Security:** Multi-tenant resolution via custom HTTP headers (`X-Tenant`) with **source verification**, and secure **httpOnly Cookie-based Authentication** out of the box.
